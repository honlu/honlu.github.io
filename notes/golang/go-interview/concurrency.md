---
title: Go 并发面试题：goroutine、select、context、GMP 模型
date: 2026-08-31
category: Golang
tags: [Go, 并发, 面试]
summary: Go 并发基础面试题，覆盖 goroutine 原理、channel 用法、select 机制、context 传递、GMP 调度等。
---
> Go 并发基础面试题，覆盖 goroutine 原理、channel 用法、select 机制、context 传递、GMP 调度等。
