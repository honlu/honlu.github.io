---
title: Go sync 包面试题：Mutex、RWMutex、WaitGroup、Pool
date: 2026-08-31
category: Golang
tags: [Go, 并发, sync]
summary: Go 并发 sync 包面试题，覆盖 Mutex / RWMutex / WaitGroup / Pool / Once 等并发原语。
---
> Go 并发 sync 包面试题，覆盖 Mutex / RWMutex / WaitGroup / Pool / Once 等并发原语。
