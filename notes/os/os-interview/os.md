---
title: 操作系统面试题：进程、内存、文件系统、IO 模型
date: 2026-08-31
category: OS
tags: [操作系统, 面试]
summary: 操作系统面试题整理，覆盖进程/线程、内存管理、文件系统、IO 模型、死锁等。
---
> 操作系统面试题整理，覆盖进程/线程、内存管理、文件系统、IO 模型、死锁等。

# 开篇碎碎念

整理自 *Go-Interview* 仓库的 操作系统 模块，从进程管理、内存管理、文件系统、IO 模型等几个角度展开。内容偏「八股文」，但作为面试速查表很合适。

> 适合人群：准备后端 / 系统方向面试、需要复习操作系统核心概念的同学。
##  1. 进程和线程的区别？
